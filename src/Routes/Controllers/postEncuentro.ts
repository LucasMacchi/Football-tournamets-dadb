...
export default async function postEncuentro (fecha_hora: string, equipo_1: number, equipo_2: number, rueda: number){
    ...
    values ('${fecha_hora}', '${equipo_1}', '${equipo_2}', '${arbitro.arbitroid}', '${cancha.canchaid}','${rueda}')`
}